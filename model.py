...
# C:\Users\adars_2a1b4od\OneDrive\Desktop\Restaurant-Review-Sentiment-Analysis\model.py
# Loading the dataset
df = pd.read_csv('C://Users//adars_2a1b4od//OneDrive//Desktop//Restaurant-Review-Sentiment-Analysis//Restaurant_Reviews.tsv', delimiter="\t")
